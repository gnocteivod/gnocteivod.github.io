...
(function checkAdminAuth() {
    ...
    if (!user) { window.location.href = 'auth.html?mode=login&redirect=admin.html'; return; }
    if (user.role !== 'admin') {
        // Allow admin@eventhub.vn or admin user
        if (user.email !== 'admin@eventhub.vn' && user.name !== 'Admin') {
